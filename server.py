...
# cascade_path = 'C:\\Users\\tejas\\GitHub\\Augmented_Reality_Assistant\\haarcascade_frontalface_default.xml' # replace with your own haarcascade_frontalface_default.xml path (for face detection)
...
# fd_x, fd_y, fd_w, fd_h = None, None, None, None   #(for face detection)
...
#face detection
# face_cascade = cv2.CascadeClassifier(cascade_path) # (for face detection)
...
def display():
    ...
    while True:
            ...
            if square:
                ...
                img = cv2.putText(frame, "x", (left(51.7), top(12)), font, obj_size*5, (0,0,255), obj_strok, cv2.LINE_AA)
...
def assistantProgram():
        ...
        while True:
            ...
            #face detection # (for face detection)
